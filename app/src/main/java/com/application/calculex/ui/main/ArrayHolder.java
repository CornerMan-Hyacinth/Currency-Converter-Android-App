...
public class ArrayHolder {
    String[] currencyCodes = {
            ...
            "BSD", "BTN", "BWP", "BYN", "BYR", "BZD", "CAD", "CDF", "CHF",
    ...
    String[] cryptoCodes = {
            "BTC", "ETH", "XRP", "LTC", "BCH", "BSV", "EOS", "BNB", "XTZ", "DOT",
            "ADA", "LINK", "XLM", "DOGE", "USDT", "WAVES", "SOL", "YFI", "UNI", "FIL"
    };

    String[] stockCodes = {
            "AAPL", "GOOGL", "AMZN", "MSFT", "FB", "BABA", "TSLA", "WMT", "BAC", "GE",
            "CVX", "JPM", "WFC", "PG", "INTC", "CMCSA", "C", "VZ", "PFE", "MCD"
    };
